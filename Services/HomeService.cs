            ...
            var viewModel = new HomeIndexViewModel
            {
                ...
                TopSellCollection = new TopSellViewModel
                {
                    ...
                    ProductItems = topSellProducts.Select(product => new ProductViewModel
                    {
                        ...
                        Price = new PriceViewModel
                        {
                            OrdinaryPrice = product.Price?.IsOrdinaryPrice == true ? product.Price.OrdinaryPrice : null,
                            OriginalPrice = product.Price?.IsOriginalPrice == true ? product.Price.OriginalPrice : null,
                            DiscountPrice = product.Price?.IsDiscountPrice == true ? product.Price.DiscountPrice : null,
                        },
                        IsIcon = false,
                        IsTitleCenter = false,
                        ImageData = product.ImageData,
